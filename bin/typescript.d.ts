...
declare module "typescript" {
    ...
    const enum SyntaxKind {
        ...
        TemplateSpan = 181,
        SemicolonClassElement = 182,
        Block = 183,
        VariableStatement = 184,
        EmptyStatement = 185,
        ...
        WithStatement = 196,
        SwitchStatement = 197,
        LabeledStatement = 198,
        ThrowStatement = 199,
        TryStatement = 200,
        DebuggerStatement = 201,
        VariableDeclaration = 202,
        VariableDeclarationList = 203,
        ...
        HeritageClause = 226,
        CatchClause = 227,
        PropertyAssignment = 228,
        ShorthandPropertyAssignment = 229,
        EnumMember = 230,
        SourceFile = 231,
        JSDocTypeExpression = 232,
        JSDocAllType = 233,
        JSDocUnknownType = 234,
        JSDocArrayType = 235,
        JSDocUnionType = 236,
        JSDocTupleType = 237,
        JSDocNullableType = 238,
        JSDocNonNullableType = 239,
        JSDocRecordType = 240,
        JSDocRecordMember = 241,
        JSDocTypeReference = 242,
        JSDocOptionalType = 243,
        JSDocFunctionType = 244,
        JSDocVariadicType = 245,
        JSDocConstructorType = 246,
        JSDocThisType = 247,
        JSDocComment = 248,
        JSDocTag = 249,
        JSDocParameterTag = 250,
        JSDocReturnTag = 251,
        JSDocTypeTag = 252,
        JSDocTemplateTag = 253,
        SyntaxList = 254,
        Count = 255,
        FirstAssignment = 53,
        LastAssignment = 64,
